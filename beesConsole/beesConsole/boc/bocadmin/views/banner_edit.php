...
<div class="boxed">
	...
	<?php echo form_open(current_urlc(), array('class' => 'form-horizontal', 'id' => 'frm-edit')); ?>
		...
		<div class="boxed-inner seamless">
			...
			<div class="control-group">
				<label class="control-label" for="status">是否新页面打开</label>
				<div class="controls">
					<?php
					$target = array(
						array(
					...
					echo ui_btn_switch('target',set_value("target",$it['target']),$target);
					?>
					<span class="help-inline"></span>
				</div>
			</div>
				...
				<div class="controls">
					<div class="btn-group">
						<span class="btn btn-success">
							...
							<?php if(in_array($_GET['c'],array(0))){echo '图片尺寸[1920x979]';}?>
							</span>
						</span>
