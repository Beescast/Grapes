...
?>
<body>
<div id="body-main" style="background: #6699cc url('<?php echo STATIC_URL.'wall/'.rand(1,9).'.jpg'; ?>');background-size:100%;">
	...
	<div class="container" id="body-main-login" >
		...
		<div class="boxed" id='login'  >
	        ...
	        ?>
				<div class="boxed-inner seamless">
					<h3 style="padding:20px 0 0 27px;"> <i class="fa fa-sign-in"></i> 瓜皮弹幕控制台<?php echo lang('login') ?> </h3>
		...
		<div style="text-align:center;color:#0088cc; font-size:14px; margin-top:400px;"><a href="" target="_blank"></div>
	</div>
