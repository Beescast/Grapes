...
class Room extends Modules_Controller
{
    ...
    protected $rules = array(
        ...
        // "field" => "RepeatBarrage",
        // "label" => '重复弹幕次数',
        // "rules" => "trim|numeric|required|callback_RepeatBarrage_check"
        // )
                )
    );
...
//         }
        ...
        if ($get_data != 'Successful operation') {
            ...
            $url = setroom_url($data['title'], $data['AccountNumber'], $data['LoginInterval'], $send_audit, $data['SpeechInterval']);
    ...
    protected function _edit()
    {
        ...
        if ($get_data != 'Successful operation') {
            ...
            // $url=sendmsg_url($data['title'],$data['content'],$data['RepeatBarrage']);
...
//         }
    ...
    //$room_data = getRoomStatusFromDouYu('1876728');
    
    //$room_data['data']['owner_name']
