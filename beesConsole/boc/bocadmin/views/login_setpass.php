...
<div id="body-main">
	...
	<div style="text-align:center;color:#0088cc; font-size:14px; margin-top:400px;"><a href="" target="_blank"> <?php echo lang('boc') ?> </a> 客服热线：<?php echo lang('boc404');?> </div>
</div>

<div id="body-footer">
	<div class="container-fluid">
		<p class="muted credit"><a href=""> &copy;</a> .</p>
	</div>
</div>
