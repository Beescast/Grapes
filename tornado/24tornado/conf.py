...
uid=[]
filter_words = [
    '[0-9a-zA-Z\.]{6,13}','微信', '威信','[v|V|weixin|wx|WX]', '性爱', '[q|Q]','3p','[jj|JJ|jb|JB|Jb|jB]',
    '艹','点播', '大片', '黄网','[sb|SB|Sb|sB]',"傻逼","傻B",'[2B|2b]','[av|AV|Av|aV]','\[emot:dy\d+\]','感谢','豆瓣',
...
reg1=re.compile(r"[\s+\.\!\?\/_$%=\^*\(+\"\']+".decode('utf-8'))
